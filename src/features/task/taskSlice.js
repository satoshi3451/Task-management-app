...
export const fetchAsyncGet=createAsyncThunk("take/get", async () =>{
...
export const fetchAsyncCreate=createAsyncThunk("take/post", async (task) =>{
...
export const fetchAsyncUpdate=createAsyncThunk("take/put", async (task) =>{
...
export const fetchAsyncDelete=createAsyncThunk("take/delete", async (id) =>{
